...
//	}
	...
	GPIO_InitStruct_ctrl.Pin   = DECODE_PIN(ce_pin) | DECODE_PIN(cs_pin);
	...
	HAL_GPIO_WritePin(gpio_base, DECODE_PIN(cs_pin), GPIO_PIN_SET);
	HAL_GPIO_WritePin(gpio_base, DECODE_PIN(ce_pin), GPIO_PIN_RESET);
