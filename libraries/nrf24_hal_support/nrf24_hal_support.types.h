struct nrf24_hal_support_interface
{
	...
	*/
	void(*Configure)(uint32_t spi_base, int32_t int_pin, uint32_t ext_int_id, uint32_t ce_pin, uint32_t cs_pin, NrfSpiDevice_ptr device_ptr, nrf_fault_handler handler);
	/** 
