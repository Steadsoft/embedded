...
{
	_ReadSingleByteRegister(device_ptr, NrfRegister.EN_AA, &(Value->value), NrfStatus);
}
static void _WriteEnAaRegister(NrfSpiDevice_ptr device_ptr, NrfReg_EN_AA Value, NrfReg_STATUS_ptr NrfStatus)
{
	_WriteSingleByteRegister(device_ptr, NrfRegister.EN_AA, Value.value, NrfStatus);
}
...
{
	_ReadSingleByteRegister(device_ptr, NrfRegister.RX_ADDR_P0 + Pipe, &(Value->value), NrfStatus);
}
...
{
	_WriteSingleByteRegister(device_ptr, NrfRegister.RX_ADDR_P0 + Pipe, Value.value, NrfStatus);
}
static void _ReadRxAddrP0Register(NrfSpiDevice_ptr device_ptr, NrfReg_RX_ADDR_ptr Value, NrfReg_STATUS_ptr NrfStatus)
{
	_ReadSingleByteRegister(device_ptr, NrfRegister.RX_ADDR_P0, &(Value->value), NrfStatus);
}
static void _WriteRxAddrP0Register(NrfSpiDevice_ptr device_ptr, NrfReg_RX_ADDR Value, NrfReg_STATUS_ptr NrfStatus)
{
	_WriteSingleByteRegister(device_ptr, NrfRegister.RX_ADDR_P0, Value.value, NrfStatus);
}
