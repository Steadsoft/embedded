...
{ 
	...
	{     
		...
		.EnAa = _ReadEnAaRegister,
		.EnRxAddr = _ReadEnRxAddrRegister,
		.SetupAw = _ReadSetupAwRegister,
		.SetupRetr = _ReadSetupRetrRegister,
		.RfChannel = _ReadRfChannelRegister,
		.RfSetup = _ReadRfSetupRegister,
		.Status = _ReadStatusRegister,
		.ObserveTx = _ReadObserveTxRegister,
		.Cd = _ReadCdRegister,
		.RxAddr = _ReadRxAddrRegister,
		.RxPw = _ReadRxPwRegister,
	...
	{ 
		...
		.EnAa = _WriteEnAaRegister,
		.EnRxAddr = _WriteEnRxAddrRegister,
		.SetupAw = _WriteSetupAwRegister,
		.SetupRetr = _WriteSetupRetrRegister,
		.RfChannel = _WriteRfChannelRegister,
		.RfSetup = _WriteRfSetupRegister,
		.Status = _WriteStatusRegister,
		.ObserveTx = _WriteObserveTxRegister,
		.Cd = _WriteCdRegister,
		.RxAddr = _WriteRxAddrRegister,
		.RxPw = _WriteRxPwRegister,
